setGeneric("quality", function(x, which = c("all", "marker", "specimen", "replicate","plate", "overall")) {
...
setGeneric("quality<-", function(data, which = c("all", "marker", "specimen", "replicate", "plate", "overall"), value){
	standardGeneric("quality<-")
})
